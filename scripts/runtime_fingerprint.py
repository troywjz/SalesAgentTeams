...
BUILD_INPUTS = (
    ...
    ROOT / "app",
    ROOT / "data" / "business" / "identity.example.md",
    ROOT / "data" / "business" / "routing_rules.example.json",
    ROOT / "data" / "knowledge" / "faq.example.csv",
    ROOT / "data" / "knowledge" / "safety_rules.example.csv",
    ROOT / "data" / "knowledge" / "sales_cases.example.csv",
    ROOT / "data" / "knowledge" / "skus.example.csv",
    ROOT / "data" / "knowledge" / "sop.example.csv",
    ROOT / "prompts",
    ROOT / "evaluation",
