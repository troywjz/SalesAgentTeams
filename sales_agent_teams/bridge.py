...
WORKER_SKILLS = {
    "intent_worker": "intent-classification@1.0.0",
    "sop_worker": "sop-decision@1.0.0",
    "knowledge_worker": "knowledge-grounding@1.0.0",
    "conversation_worker": "reply-drafting@1.0.0",
    "safety_worker": "safety-review@1.0.0",
    "memory_worker": "memory-update@1.0.0",
}
